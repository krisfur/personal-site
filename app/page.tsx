                ...
                <div className="flex flex-col gap-8 flex-1">
                    ...
                    <div className="p-8 bg-white/5 rounded-2xl shadow-2xl w-full">
                        ...
                        <div className="text-lg leading-relaxed text-subtext space-y-3">
                            ...
                            <p>🎓 <code>PhD</code> in Particle Physics (QMUL).</p>

                            <p>
                                💻 Experienced in <code>C++</code>, <code>Go</code>, <code>Python</code>,
                                <code>Rust</code>, <code>SQL</code>, and <code>TypeScript</code> in software
                                development and data science environments.
                            </p>

                            <p>
                                ☁️ Proficient in cloud deployment (DevOps) and data infrastructure
                                (DataOps) on <code>Azure</code> and <code>AWS</code>, orchestration through
                                <code>Apache Airflow</code>, and data management with <code>Snowflake</code>.
                            </p>
